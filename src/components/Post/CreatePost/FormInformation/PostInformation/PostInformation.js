    ...
    <div className="container-post-information">
      ...
      >
        ...
        <Form.Item
          ...
          label="Người liên hệ"
        >
          <Input value={props.contact} defaultValue={props.contact}
        ...
        <Form.Item
          ...
          label="Số điện thoại"
        >
          <Input value={props.phone} defaultValue={props.phone}
            onChange={(e) => props.setPhone(e.target.value)} />
        </Form.Item>
        <Form.Item name="title" label="Tiêu đề bài đăng">
          <Input value={props.title} defaultValue={props.title || props.roomName}
        ...
        {
          !props.isSelfGovernance && <Form.Item
            name="strictTime"
        ...
        {!props.isSelfGovernance && props.strictTime === "Có" && (
          <>
            <Form.Item name="StrictTimeStart" label="Thời gian bắt đầu">
              <Input value={props.strictTimeStart}
            ...
            <Form.Item name="StrictTimeEnd" label="Thời gian kết thúc">
              <Input value={props.strictTimeEnd}
